...
const Footer = () => {
  return (
    <div className=" bg-gradient-to-bl from-blue-50 to-green-50 lg:h-full ">
          <div className=" flex flex-col w-[80%] m-auto py-6 ">
            ...
            <div className=" flex flex-col md:grid-cols-2 md:grid lg:flex lg:flex-row lg:items-center gap-10 lg:gap-0 items-start lg:justify-between py-10 lg:py-20">
            ...
            <div className=' flex items-center justify-between py-6 text-gray-500'>
              <p className=' text-[10px] lg:text-[15px]'>&copy; Copyright 2024, All Rights Reserved</p>
              <div className=' flex gap-1 lg:gap-20 text-[10px] lg:text-[15px]'>
                <Link href='/'>
                  <p>Privacy Policy</p>
                </Link>
                <Link href='/'>
